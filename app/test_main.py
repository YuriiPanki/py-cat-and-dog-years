...
@pytest.mark.parametrize(
    "cat_age,exception",
    [
        pytest.param("0", TypeError, id="str - TypeError"),
        pytest.param([0, 1], TypeError, id="list - TypeError"),
        pytest.param((0, 0), TypeError, id="tuple - TypeError"),
        pytest.param({0: 0, 1: 1}, TypeError, id="dict - TypeError"),
    ]
)
